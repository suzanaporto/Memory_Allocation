        ...
        while len(list_p) >= 0:
            ...
            for seg_idx in range(len(mem_seg_f)):
                ...
                if mem_seg_f[seg_idx].space >= list_p[p].size:
                    ...
                    #check if its the first one and set as best idx
                    if best_idx == -1:
                        best_idx = seg_idx
                        #check if actual segment is smaller
                    elif mem_seg_f[best_idx].space > mem_seg_f[seg_idx].space:
                        best_idx = seg_idx
                ...
                if seg_idx == len(mem_seg_f) - 1:
                    ...
                    mem_seg_f[best_idx].space = mem_seg_f[best_idx].space - list_p[p].size

                    #representation inside memory rectangle
                    rect_mem = canvas.create_rectangle(mem_seg_f[best_idx].x1, 20,
                                                       mem_seg_f[best_idx].x1 + list_p[p].size,
                    ...
                    seg_atual = Mem_Seg(name_ms=list_p[p].name,
                                    id_ms=0,
                                    space=list_p[p].size,
                                    x1=mem_seg_f[best_idx].x1,
                                    x2=mem_seg_f[best_idx].x1 + list_p[p].size)
