...
class First_fit:
    ...
    #run algorithm/receives process list as a parameter
        ...
        while len(list_p) >= 0:
            ...
            for seg_idx in range(len(mem_seg_f)):
                ...
                if mem_seg_f[seg_idx].space >= list_p[p].size:
                    ...
                    mem_seg_f[seg_idx].space = mem_seg_f[seg_idx].space - list_p[p].size

                    #reoresentation inside memory rectangle
                    rect_mem = canvas.create_rectangle(mem_seg_f[seg_idx].x1, 20,
                                                       mem_seg_f[seg_idx].x1 + list_p[p].size,
                                                       70,
                                                       fill='green', tag=str(list_p[p].name))
                    ...
                    seg_atual = Mem_Seg(name_ms=list_p[p].name,
                                        id_ms=0,
                                        space=list_p[p].size,
                                        x1=mem_seg_f[seg_idx].x1,
                                        x2=mem_seg_f[seg_idx].x1 + list_p[p].size)
